...
class GIFTEval:
    ...
    def __init__(
        ...
        Example:
            ```python
            import pandas as pd
            from TimeMAC.gift_eval.eval import GIFTEval
            from TimeMAC.gift_eval.gluonts_predictor import GluonTSPredictor
            from TimeMAC.models.stats import SeasonalNaive
            ...
            predictor = GluonTSPredictor(
                ...
                # [Forecaster][TimeMAC.models.utils.forecaster.Forecaster]
